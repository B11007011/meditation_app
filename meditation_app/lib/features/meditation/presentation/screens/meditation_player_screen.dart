...
class _MeditationPlayerScreenState extends State<MeditationPlayerScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final playerService = Provider.of<MeditationPlayerService>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    return Consumer<MeditationPlayerService>(
      builder: (context, playerService, child) {
        final isPlaying = playerService.playbackState == PlaybackState.playing;
            ...
            child: SafeArea(
              child: Column(
                children: [
                  _buildHeader(),
                  Expanded(
                    child: _buildMeditationContent(playerService),
                  ),
  ...
  Widget _buildMeditationContent(MeditationPlayerService playerService) {
    return Padding(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text(
                      _formatDuration(playerService.duration.inMilliseconds > 0
  ...
  Widget _buildPlayerControls(MeditationPlayerService playerService) {
    final isPlaying = playerService.playbackState == PlaybackState.playing;
    final isPaused = playerService.playbackState == PlaybackState.paused;
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () {
              final newPosition = playerService.position - const Duration(seconds: 15);
          ...
          IconButton(
            ...
            onPressed: () {
              final newPosition = playerService.position + const Duration(seconds: 15);
              final maxDuration = playerService.duration.inMilliseconds > 0
                  ? playerService.duration
                  : widget.meditation.duration;
